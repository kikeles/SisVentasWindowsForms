...
namespace Sistema.Negocio
{
    public class NPersona
    {
        ...
        {
            DPersona Datos = new DPersona();
            //validar si ya existe el nombre ya está registrado
        ...
        public static string Actualizar(int Id, string TipoPersona, string NombreAnt, string Nombre, string TipoDocumento, string NumDocumento,
            string Direccion, string Telefono, string Email)
        {
            DPersona Datos = new DPersona();
            Persona Obj = new Persona();
