    ...
    public partial class FrmCliente : Form
    {
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    Rpta = NPersona.Insertar("Cliente",TxtNombre.Text.Trim(),CboTipoDocumento.Text, 
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //Rpta (Respuesta) proviede de la capa Datos pasando por la capa Negocio
                    Rpta = NPersona.Actualizar(Convert.ToInt32(TxtId.Text),"Cliente",this.NombreAnt, TxtNombre.Text.Trim(), CboTipoDocumento.Text,
                        TxtNumDocumento.Text.Trim(), TxtDireccion.Text.Trim(),
                        TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
                    if (Rpta.Equals("OK"))
                    {
        ...
        /*Para copiar un formulario, el evento Load
         * 
         * 
         */
