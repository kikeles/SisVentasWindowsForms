...
namespace Sistema.Presentacion
{
    public partial class FrmPrincipal : Form
    {
        ...
        //variables para la gestión de acceso al sistema
        ...
        private void categoríaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //indica que el MDI padre sea el contenedor del FrmCategoria
            frm.MdiParent = this;
            frm.Show();
        }
        ...
        private void usiariosToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            StBarraInferior.Text = "Desarrollado por Sonic S.A de C.V | Usuario:" + this.Nombre;
            MessageBox.Show("Bienvenido "+this.Nombre, "Sistema de Ventas", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //Ocultar o mostrar opciones del menu segun su Rol
